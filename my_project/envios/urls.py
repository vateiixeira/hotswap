...
urlpatterns = [
    ...
    path('listagem-envio-pendente', lista_envio_pendente, name='lista_envio_pendente'),
    ...
    path('pdf/data/envios-pendentes/', PdfEnviosPendentes.as_view(), name='pdfpendentesenvios'),
