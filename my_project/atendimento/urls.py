...
urlpatterns = [
    ...
    path('rel/responsavel/', atendimento_por_responsavel, name='atendimento_por_responsavel'),
    ...
    path('pdf/data/usuario/<str:dtinicial>/<str:dtfinal>/<int:usuario>', PdfTecnicoAtendimento.as_view(), name='pdftecnico'),
    path('pdf/data/responsavel/<str:dtinicial>/<str:dtfinal>/<int:usuario>', PdfResponsavelAtendimento.as_view(), name='pdftecnico'),
